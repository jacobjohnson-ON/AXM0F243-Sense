...
// TX: fcarrier=868.300MHz dev=  6.667kHz br= 20.000kBit/s pwr= 15.0dBm
// RX: fcarrier=868.300MHz bw= 30.000kHz br= 20.000kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_IFFREQ1,             0x04);
	radio_write8(AX5043_REG_IFFREQ0,             0x44);
	radio_write8(AX5043_REG_DECIMATION,          0x0A);
	...
	radio_write8(AX5043_REG_FSKDEV1,             0x09);
	radio_write8(AX5043_REG_FSKDEV0,             0x1A);
	radio_write8(AX5043_REG_MODCFGA,             0x05);
	radio_write8(AX5043_REG_TXRATE2,             0x00);
	radio_write8(AX5043_REG_TXRATE1,             0x1B);
	radio_write8(AX5043_REG_TXRATE0,             0x4F);
	...
	radio_write8(AX5043_REG_RSSIABSTHR,          0xE6);
...
{
	radio_write8(AX5043_REG_TMGRXAGC,                 0x02);
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 18; // wor_longlen + wor_len totals to 240.0ms plus 32bits
...
const uint32_t __code axradio_framing_ack_timeout = 432; // 10.8ms in wtimer0 units (40000Hz)
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 320, 215, 284 };// 9.757ms, 6.553ms, 8.658ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 399, 189, 327 }; // 12.168ms, 5.759ms, 9.971ms
const uint32_t __code axradio_sync_slave_rxtimeout = 253; // 7.7ms, maximum duration of a packet
