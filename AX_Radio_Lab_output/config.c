...
// TX: fcarrier=868.300MHz dev= 16.667kHz br= 50.000kBit/s pwr=  0.0dBm
// RX: fcarrier=868.300MHz bw= 75.000kHz br= 50.000kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_PINFUNCDCLK,         0x01);
	radio_write8(AX5043_REG_PINFUNCDATA,         0x01);
	...
	radio_write8(AX5043_REG_IFFREQ1,             0x08);
	radio_write8(AX5043_REG_IFFREQ0,             0x89);
	radio_write8(AX5043_REG_DECIMATION,          0x04);
	radio_write8(AX5043_REG_RXDATARATE2,         0x00);
	radio_write8(AX5043_REG_RXDATARATE1,         0x3C);
	...
	radio_write8(AX5043_REG_MAXRFOFFSET0,        0x5F);
	...
	radio_write8(AX5043_REG_FSKDEV1,             0x16);
	radio_write8(AX5043_REG_FSKDEV0,             0xC1);
	radio_write8(AX5043_REG_MODCFGA,             0x05);
	radio_write8(AX5043_REG_TXRATE2,             0x00);
	radio_write8(AX5043_REG_TXRATE1,             0x44);
	radio_write8(AX5043_REG_TXRATE0,             0x44);
	radio_write8(AX5043_REG_TXPWRCOEFFB1,        0x02);
	radio_write8(AX5043_REG_TXPWRCOEFFB0,        0x07);
	radio_write8(AX5043_REG_PLLVCOI,             0x99);
	radio_write8(AX5043_REG_PLLRNGCLK,           0x05);
	radio_write8(AX5043_REG_BBTUNE,              0x09);
...
#else
	PALTRADIO = 0x40; //pass through PWRAMP -> PB2 
#endif
...
{
	ax5043_set_pwramp_pin(0x00);
	ax5043_set_antsel_pin(0x7f);
...
const uint16_t __code axradio_phy_cs_period = 400; // timer0 units, 10ms
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 47; // wor_longlen + wor_len totals to 240.0ms plus 32bits
const uint16_t __code axradio_phy_preamble_wor_len = 0;
...
const uint32_t __code axradio_framing_ack_timeout = 234; // 5.8ms in wtimer0 units (40000Hz)
...
// synchronous mode
const uint32_t __code axradio_sync_period = 163840; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code axradio_sync_xoscstartup = 49;
const uint32_t __code axradio_sync_slave_syncwindow = 491520; // 15.000s
...
const int16_t __code axradio_sync_slave_maxperiod = 3698; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 239, 134, 203 };// 7.267ms, 4.063ms, 6.168ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 318, 108, 246 }; // 9.678ms, 3.269ms, 7.481ms
const uint32_t __code axradio_sync_slave_rxtimeout = 101; // 3.1ms, maximum duration of a packet
